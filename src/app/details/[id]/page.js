...
export default function Page() {
  ...
  const { call = [], setCall } = useContext(CallContext); // ✅ safe default
  ...
  const handleCall = (type) => {
    ...
    setCall([
      ...call,
      {
        ...
        type: type,
        date: singleData.next_due_date, // ✅ fixed name
      },
    ]);
        ...
        <div className="flex gap-5">
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="flex gap-4">
              <div className="bg-white shadow rounded-lg p-5 w-[150px] text-center">
              ...
              <div className="bg-white shadow rounded-lg p-5 w-[200px] text-center">
